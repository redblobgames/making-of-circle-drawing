...
<summary>See the diff</summary>
<figure>
  <a-step step="14" :diff="true" restrict="diagram-distance" />
</figure>
</details>
#+end_export
...
<summary>See the diff</summary>
<figure>
  <a-step step="15" :diff="true" restrict="diagram-distance" />
...
I think this design without the red helps the reader focus on distances.
...
After removing the radius slider, there's no place that shows the actual radius. I could display the value with a measure line and also in the figure caption.
...
Earlier I said that I find that I make better diagrams if I start with copy/paste and work on the diagram before I try to build abstractions. At this point I can see the two diagrams and can factor the common parts into a component. The main thing that's in common but not yet abstracted is the grid. Let's create a grid component:
...
<x:footer>
  ...
  ; &#160;
  <!-- hhmts start -->Last modified: 22 Dec 2022<!-- hhmts end -->
</x:footer>
#+end_export
